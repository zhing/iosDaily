...
//    }
    ...
    _screenshotImgView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
...
- (nullable id <UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if (([fromVC isMemberOfClass:[ZHBarViewController class]] || [fromVC isMemberOfClass:[ZHBarNextViewController class]]) && ([toVC isMemberOfClass:[ZHBarViewController class]] || [toVC isMemberOfClass:[ZHBarNextViewController class]])) {
...
- (void)dragging:(UIPanGestureRecognizer *)pan
{
    ...
    if (offsetX < SCREEN_WIDTH) {
        ...
        _screenshotImgView.transform = CGAffineTransformMakeTranslation((offsetX - SCREEN_WIDTH) * 0.6, 0);
    }
...
- (void)dragEnd
{
    ...
    if (translateX <= 180) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            _screenshotImgView.transform = CGAffineTransformMakeTranslation(-SCREEN_WIDTH, 0);
