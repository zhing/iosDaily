...
enum HMSelectionIndicatorMode {
    ...
    HMSelectionIndicatorResizesToStringWidthDouble = 2, // Indicator width will only be as big as the text width * 2
};

enum HMSelectionIndicatorPosition {
    HMSelectionIndicatorPositionTop = 0,
    HMSelectionIndicatorPositionBottom = 1
};
...
@property (nonatomic, assign) enum HMSelectionIndicatorPosition selectionIndicatorPosition; // Default is HMSelectionIndicatorPositionTop
