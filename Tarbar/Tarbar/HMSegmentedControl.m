...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorPosition == HMSelectionIndicatorPositionBottom) {
        yPosition = self.height - self.selectionIndicatorHeight;
    }
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, yPosition, stringWidth, self.selectionIndicatorHeight);
    }
    else if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidthDouble) {
        CGFloat widthTillEndOfSelectedIndex = (self.segmentWidth * self.selectedIndex) + self.segmentWidth;
        CGFloat widthTillBeforeSelectedIndex = (self.segmentWidth * self.selectedIndex);
        
        CGFloat x = ((widthTillEndOfSelectedIndex - widthTillBeforeSelectedIndex) / 2) + (widthTillBeforeSelectedIndex - stringWidth / 2);
        return CGRectMake(x - stringWidth/2, yPosition, stringWidth * 2, self.selectionIndicatorHeight);
    }
    else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, yPosition, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
